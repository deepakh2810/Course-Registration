                  ...
                  <div className="col-md-6 m-auto">
                    <div className="shadow-lg p-4 mb-10 bg-grey rounded">
                      <h1 className="display-4 text-center">Cart</h1>
                          <hr/>
                          <p className="lead text-left"  style={{color: 'black'}} >Price of Courses: <br/> <i className="fa fa-shopping-cart" /> </p>
                      ...
                      //    { this.props.studentinfo.studentinfobyname.map(course => (              ))}

                            for( let i = 1; i <= numofcoursesincart; i++ ){

                          return(<p className="lead text-left" style={{color: 'black'}}> {listcourseprice[i]} </p> );
                        }
                      } ) ()}

                          <p className="lead text-left" style={{color: 'black'}} > Total Number of Courses in Cart: {numofcoursesincart}  </p>
                          <p className="lead text-left" style={{color: 'black'}} > Total Cost of Courses: {1000 * numofcoursesincart}</p>
                      ...
                      <p className="lead text-left" style={{color: 'black'}} >Financial Aid Deduction: {this.props.enteredfinancialaid && <p> {this.props.enteredfinancialaid} </p> } </p>
                      {this.props.error && <p> {this.props.error} </p> }

                      <p className="lead text-left" style={{color: 'black'}} > Total Cost after Financial Aid: {this.props.newpricetotal && <p> {this.props.newpricetotal} </p> }  </p>
