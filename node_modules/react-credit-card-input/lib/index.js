    ...
    _this.handleCardNumberBlur = function () {
      ...
      return function (e) {
        ...
        if (!payment.fns.validateCardNumber(e.target.value)) {
          _this.setFieldInvalid(customTextLabels.invalidCardNumber || 'Card number is invalid');
        }
    ...
    _this.handleCardCVCBlur = function () {
      ...
      return function (e) {
        ...
        if (!payment.fns.validateCardCVC(e.target.value)) {
          _this.setFieldInvalid(customTextLabels.invalidCvc || 'CVC is invalid');
        }
    ...
    _this.handleCardZipBlur = function () {
      ...
      return function (e) {
        ...
        if (!isZipValid(e.target.value)) {
          _this.setFieldInvalid(customTextLabels.invalidZipCode || 'Zip code is invalid');
        }
